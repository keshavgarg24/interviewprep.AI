...
export default function Home() {
  return (
    <div>
      ...
      />
      <Header />
      <section className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 md:py-16 md:px-12">
        <a
        ...
        <h1 className="mb-4 text-4xl font-black tracking-tight leading-none text-blue-700 md:text-5xl lg:text-6xl dark:text-white">
      ...
      <div className="flex flex-col justify-center items-center min-h-screen p-4">
        <div className="border rounded-lg bg-gray-100 p-4 max-w-4xl w-full mx-auto">
          <section className="py-8 px-4 text-center lg:py-16 lg:px-12">
            <h2 className="font-extrabold text-2xl md:text-3xl lg:text-5xl">
              What Users have experienced after using interviewprep.AI
            </h2>
      ...
      <div className="flex flex-col justify-center items-center p-4 mb-8">
        <div className="border rounded-lg bg-gray-100 p-4 max-w-4xl w-full mx-auto">
          <section className="py-8 px-4 text-center lg:py-16 lg:px-12">
            <h2 className="font-extrabold text-2xl md:text-3xl lg:text-5xl">
              Ready to excel in refining your interview skills?
            </h2>
            <Link href="/dashboard">
